          ...
          items: [
            ...
            },
            {
              ...
              subitems: [
                ...
                },
                {
                  label: 'NEAR MCP',
                  to: '/ai/near-mcp',
                  description: 'Integrate AI applications with NEAR MCP',
                },
                {
                  label: 'Shade Agents',
            ...
            },
            {
              ...
              subitems: [
                ...
                {
                  label: 'NEAR Lake',
                  to: '/data-infrastructure/lake-framework/near-lake-framework',
              ...
              subitems: [
                {
                  ...
                  icon: '/docs/assets/welcome-pages/experiment.png',
                },
                {
                  label: 'Indexers',
                  to: '/tools/indexing',
                  description: 'Build custom indexers to query on-chain data',
                  icon: '/docs/assets/welcome-pages/blocks.png',
                },
              ],
            },
            {
          ...
          items: [
            {
              ...
              subitems: [
                ...
                },
                {
                  ...
                  icon: '/docs/assets/welcome-pages/update.png',
                },
                {
